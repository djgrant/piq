 ...
 */
export type ExtractPathParams<P extends string> = P extends `${string}{...${infer Param}}${infer Rest}` ? Param | ExtractPathParams<Rest> : P extends `${string}{?${infer Param}}${infer Rest}` ? Param | ExtractPathParams<Rest> : P extends `${string}{${infer Param}}${infer Rest}` ? Param | ExtractPathParams<Rest> : never;
/**
 ...
 */
export interface CollectionDefinition<TSearch = unknown, TMeta = unknown, TBody = unknown> {
 ...
 */
export type CollectionRegistry = Record<string, CollectionDefinition<unknown, unknown, unknown>>;
/**
